...
app.post('/weather', async (req, res) => {
  ...
  try {
    ...
    const weatherToSong = {
      Clear: 'https://youtu.be/FBdqEtxQpaY?si=-jS9mWzT3e9CoxmD',       // gali ajj chand
      Rain: 'https://youtu.be/B1dmwRBVqWI?si=o-IofVyxb_iAT8z4',        // Tum Hi Ho
      Clouds: 'https://youtu.be/VsFpt0NA8ug?si=Vb8Oyu72FE7qeKdf',      // Phir Le Aya Dil
      Snow: 'https://youtu.be/jRZVnLrwT8U',        
      Thunderstorm: 'https://youtu.be/dUHZ7cA3KyM' 
    };
